...
class Plugin(PackerResource):
    ...
    def __init__(self, name, version, version_op, source):
...
class AmazonEbs(BuilderSourceConfig):
    ...
    def __init__(self, name, ami_name, region, access_key, secret_key, **kwargs):
        ...
        self.launch_block_device_mappings: AmazonEbs.LaunchBlockDeviceMappings = kwargs.get(
...
class DockerBuilder(BuilderSourceConfig):
    ...
    def __init__(self, name, image, message="", commit=None, discard=None, export_path=None, **kwargs):
...
class ShellProvisioner(Provisioner):
    ...
    def __init__(self, inline=None, script=None, scripts=None, **kwargs):
...
class ShellLocalProvisioner(Provisioner):
    ...
    def __init__(self, command=None, inline=None, script=None, scripts=None, **kwargs):
...
class FileProvisioner(Provisioner):
    ...
    def __init__(self, content=None, source=None, destination=None, **kwargs):
...
class PostProcessor(BuilderResource):
    ...
    def merge_post_processor_json(*post_processors) -> dict:
        ret = {"post-processors": [{"post-processor": {}}]}
